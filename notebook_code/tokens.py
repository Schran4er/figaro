...
from constants import INSTRUMENT_KEY, CHORD_KEY, TIME_SIGNATURE_KEY, MAX_BAR_LENGTH, PITCH_KEY, VELOCITY_KEY, \
    DURATION_KEY, TEMPO_KEY, BAR_KEY, POSITION_KEY, DEFAULT_VELOCITY_BINS, DEFAULT_DURATION_BINS, \
    DEFAULT_TEMPO_BINS, MAX_N_BARS, DEFAULT_POS_PER_QUARTER, NOTE_DENSITY_KEY, DEFAULT_NOTE_DENSITY_BINS, \
    MEAN_VELOCITY_KEY, DEFAULT_MEAN_VELOCITY_BINS, MEAN_PITCH_KEY, DEFAULT_MEAN_PITCH_BINS, MEAN_DURATION_KEY, \
    DEFAULT_MEAN_DURATION_BINS, \
    PAD_TOKEN, BOS_TOKEN, EOS_TOKEN, UNK_TOKEN, MASK_TOKEN
